...
closet.help = Skap-kommandoer: help | show | hear | name <tekst> | description <tekst> | alias <tekst> | apply [ipns_key_base64] | citizen [ipns_key_base64] | recovery set <passphrase> | recovery status | recovery rekey <@handle> <passphrase>
closet.help.prompt = Du er i skapet uten avatar ennå. Kreves: name + description + alias. Kjør så apply. Når du er klar, skriv 'go lobby' i actor-UI.
closet.required_fields = påkrevde felt er: name, description, alias
closet.required_fields.prompt = sett name/description/alias, og kjør apply
closet.apply.updated = endringer brukt. Du kan bli i skapet og fortsette å redigere; skriv 'go lobby' når du er klar.
closet.apply.accepted = søknad godkjent. skriv 'go lobby' i actor-UI for å gå inn i verden.
...
closet.recovery.rekey.requires_new_did = recovery rekey krever en ny DID i denne sesjonen (kjør citizen først)
...
closet.command.unknown = Ukjent skap-kommando '{ $verb }'. Skriv 'help'.
closet.session.ready = skap-sesjon klar
closet.session.ready.prompt = Svar på profilspørsmål mens du venter; du kan høre lobby-hendelser herfra.
...
closet.did.published = DID-dokument publisert
