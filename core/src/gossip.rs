...
//!
//! These functions are native-only (not compiled for wasm32) and provide
//! the canonical way to join a gossip topic and send messages on it.
...
use crate::protocol::BROADCAST_TOPIC;
...
///
/// Convenience wrapper around [`join_gossip_topic`] for the well-known
/// `ma/broadcast/1` topic.
